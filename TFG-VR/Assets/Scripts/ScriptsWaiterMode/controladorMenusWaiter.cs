...
public class controladorMenusWaiter : MonoBehaviour
{
    ...
    public void showPauseMenu()
    {
        ...
        GameObject.Find("SliderWaiter").GetComponent<Slider>().value = controladorPartidaWaiter.current.current_user().getVolume();
    }
    ...
    public void showAchievementsMenu()
    {
        ...
        var achievements = controladorPartidaWaiter.current.current_user();
    ...
    public void unlockAchievement(int numLogro)
    {
