...
/// </summary>
public class controladorPartidaWaiter : MonoBehaviour
{
    [SerializeField]
    ...
    private controladorMenusWaiter controllerMenus;  // Clase controladora de los menús (entrar para ver mayor descripción). 
    ...
    private ComandaContWaiter orderGenerator; // Clase para generar y controlar las diferentes comandas (entrar para ver mayor descripción).

    private Subject subject = new Subject();
    private LogrosController achievementsController;
    // SINGLETON
    public static controladorPartidaWaiter current;
    ...
    private void Start()
    {
        ...
        controllerMenus = this.GetComponentInParent<controladorMenusWaiter>();
        //controladorMenus.menuIniciDeDia(dia_actual);

        feedbackGenerator = new FeedbackGeneratorWaiter();
        orderGenerator = new ComandaContWaiter();
    ...
    public void arriveOrder(ComandaWaiter order)
    {
